...
op.Outputs(1).y = 3.3  ; %0.01; 3, 3.3, 4, 4.59
...
% %%
% % pH is known
% op.Outputs(1).y = 10.38;
% op.Outputs(1).Known = true;

op.Inputs(1).u = 820/1000  ;

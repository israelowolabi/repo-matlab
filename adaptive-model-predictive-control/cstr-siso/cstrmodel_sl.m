...
mpcobj_sl = mpc(plant);
mpcobj_sl.PredictionHorizon = 100;
mpcobj_sl.ControlHorizon = 25;
...
mpcobj_sl.Weights.OV = 1;
mpcobj_sl.Weights.MV = 0;
mpcobj_sl.Weights.MVRate = 0.02;

% Constraint on manipulated variable is defined.
mpcobj_sl.MV.RateMin = -10;
mpcobj_sl.MV.RateMax = 10;
mpcobj_sl.MV.Min = 60;
mpcobj_sl.MV.MinECR = 0;
mpcobj_sl.MV.Max = 120;
mpcobj_sl.OV(1).Min = 0;
mpcobj_sl.OV(1).Max = 0.15;
